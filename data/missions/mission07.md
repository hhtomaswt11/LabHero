...
The mission also distinguishes a positive product objective from predicted viability: direct ethanol maximisation can produce a high theoretical secretion flux while the predicted growth rate is zero.
...
The ethanol result is a theoretical maximum predicted by this model, medium and uptake bounds. It is not a universal biological constant and it does not describe a growing production strain because the corresponding predicted growth rate is zero.
