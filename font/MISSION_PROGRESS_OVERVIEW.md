...
**Explica:** FBA maximiza novamente a biomassa admissível, enquanto lMOMA minimiza a soma dos desvios absolutos relativamente a uma solução de referência. O score lMOMA não é biomassa; a biomassa é lida da reação `BIOMASS_Ecoli_core_w_GAM` na mesma solução visível.  
