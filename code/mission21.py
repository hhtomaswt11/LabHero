...
class Mission21:
    ...
    async def update(self):
        locked_dialogue = [
            "Dr. Rio is still completing your medium-context training.",
            "Complete Mission 20 before beginning Dr. Vega's comparison laboratory.",
        ]
    ...
    def menu_message(self, message, buttons=True, menu_to_open=None):
        ...
        nome = get_dialogue_text_surface(self.font_nome, 'Dr. Vega')
