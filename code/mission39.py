...
class Mission39:
    ...
    def menu_message(self, message, buttons=True, menu_to_open=None):
        ...
        image = get_dialogue_portrait(get_resource_path('graphics/dialogues/morbus.jpg'), (150, 150))
        self.screen.blit(image, (25, 520))
        pygame.draw.rect(self.screen, 'white', [25, 675, 150, 25])
        self.screen.blit(get_dialogue_text_surface(self.font_name, 'Morbus'), (63, 677))
